...
int PickupStates[CLASSCOUNT][8] = 
{
    ...
    {"Duke64guy","Duke64Full",    "Duke64Empty",       "Duke64Special",     "Duke64Punchdrunk",     "Duke64PDFull",      "Duke64PDEmpty",     "Duke64PDSpecial"},
};
...
int BanStrings[CLASSCOUNT] =
{
	...
	"\c[m7]The admin has banned \cfDuke Nukem (N64)\c[m7] from play.",
};
